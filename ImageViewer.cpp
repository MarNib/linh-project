...
//Classif---------------->
//#include "../Classif/classification.cpp"
...
{
	QMessageBox::about(this, tr("Classification"),
		//tr(
		//	"<p><b>MAELab</b> will soon classify your images.</p>"));
			QString fileName = QFileDialog::getOpenFileName(this, tr(""), QDir::currentPath());
      system("./home/kevin/caffe/build/examples/cpp_classification/classification.bin \
            /home/kevin/caffe/models/bvlc_reference_caffenet/deploy.prototxt \
            /home/kevin/caffe/models/bvlc_reference_caffenet/bvlc_reference.caffenet.caffemodel \
            /home/kevin/caffe/data/ilsvrc12/imagenet_mean.binaryproto \
            /home/kevin/caffe/data/ilsvrc12/synset_words.txt \
            fileName")
      system("touch mytest3.txt");
      system("exit");
}
// =========================== Slots =======================================
